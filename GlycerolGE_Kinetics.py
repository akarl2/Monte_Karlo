...
Alcohol = 285.52
Epichlorohydrin = 359.39
rxn_mass_list = {"A1_E" + str(i): 0 for i in range(1, 26)}

molesA = Alcohol / ChemData["Glycerol"]["MW"]
molesB = Epichlorohydrin / ChemData["Epichlorohydrin"]["MW"]
rxn_moles_list = {"A1_E" + str(i): 0 for i in range(1, 26)}

p_mass_list = {"A1_E" + str(i): [] for i in range(1, 26)}
